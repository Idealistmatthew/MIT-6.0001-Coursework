    ...
    def apply_transpose(self, transpose_dict):
        ...
        for char in message_list:
            if char in transpose_dict:
                new_list.append(transpose_dict[char])
            else:
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for permutation in permutations_list:
            trial_transpose_dict = self.build_transpose_dict(permutation)
            trial_message = self.apply_transpose(trial_transpose_dict)
            trial_message_list.append(trial_message)

        for trial in trial_message_list:
            count = 0
